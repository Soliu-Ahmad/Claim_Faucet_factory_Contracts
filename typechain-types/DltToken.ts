...
export interface DltTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface DltToken extends BaseContract {
  connect(runner?: ContractRunner | null): DltToken;
  waitForDeployment(): Promise<this>;

  interface: DltTokenInterface;
